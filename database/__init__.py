...
def init_db():
    ...
    # Supprime les tables si elles existent pour repartir proprement
    curseur.execute('DROP TABLE IF EXISTS emprunts')
    curseur.execute('DROP TABLE IF EXISTS medias')
    curseur.execute('DROP TABLE IF EXISTS emprunteurs')
    curseur.execute('''
